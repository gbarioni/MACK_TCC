...
class ArquivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arquivo" do
    assert_difference('Arquivo.count') do
      post arquivos_url, params: { arquivo: { ano: @arquivo.ano, autor: @arquivo.autor, licenca: @arquivo.licenca, titulo: @arquivo.titulo } }
    end
  ...
  test "should update arquivo" do
    patch arquivo_url(@arquivo), params: { arquivo: { ano: @arquivo.ano, autor: @arquivo.autor, licenca: @arquivo.licenca, titulo: @arquivo.titulo } }
